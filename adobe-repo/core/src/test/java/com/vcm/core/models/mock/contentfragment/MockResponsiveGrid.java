...
@Model(adaptables = SlingHttpServletRequest.class, adapters = { ContainerExporter.class,
		ComponentExporter.class }, resourceType = MockResponsiveGrid.RESOURCE_TYPE)
...
public class MockResponsiveGrid implements ContainerExporter {
	 ...
	 *            The current request.
	 * @param modelClass
	 *            The Sling Model class to be adapted to.
	 * @return Returns a map (resource name => Sling Model class) of the given
	 *         resource children's Sling Models that can be adapted to
	 *         {@link T}.
	 */
	@NotNull
