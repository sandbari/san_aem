...
class PostloginBannerServletTest {

	@Mock
	PostloginBannerService postloginBannerService;

	public final AemContext context = new AemContext(ResourceResolverType.JCR_OAK);
	private PostloginBannerServlet postloginBannerServlet;

	@BeforeEach
	public void setup() throws Exception {
		postloginBannerServlet = new PostloginBannerServlet();
		postloginBannerServlet.setPostloginBannerService(postloginBannerService);
		Mockito.when(postloginBannerService.getPostloginBannerDetails(Mockito.any())).thenReturn("true");
	}
	...
	void testGetMethodSearchContext() throws Exception {
		...
		postloginBannerServlet.doGet(mockReq, mockRes);
